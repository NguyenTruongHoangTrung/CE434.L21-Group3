...
HD_PWD='/home/viet/Documents/UIT/CE434.L21-Group3/Assignment_2/Vivado/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2grayscale.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb2grayscale.tcl
