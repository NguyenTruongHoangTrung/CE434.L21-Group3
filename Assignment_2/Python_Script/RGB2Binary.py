...
os.chdir('/home/viet/Documents/UIT/CE434.L21-Group3/Assignment_2/Source/Image/')
print(os.getcwd())
...
for i in range(num_image):
    ...
    #cv2.imwrite('/home/viet/Documents/UIT/CE434.L21-Group3/Additional_File/Image_bin/image_'+str(count_frame)+'.png', frame)
